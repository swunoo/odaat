...
//   TaskWrapper: ({ date, addProject, newProj }: any) => <div>{date.toString()} <span>{newProj}</span> <button onClick={addProject}>New Project</button></div>
// }));
...
//     test('onProjectCreate updates newProj and hides NewProjectModal', () => {
...
//     rendered = render(<TaskContainer newProj="Test Project" setShowNewProj={setShowNewProj} />);
//   });
